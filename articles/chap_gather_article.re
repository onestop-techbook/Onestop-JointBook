...
そのために合同誌をストーリー形式とアンソロジー形式の2つに分類します。
...
書き慣れてないとテーマ決めが難しかったり、徐々にテーマからずれた原稿になってしまう場合や内容が最終的にかぶってしまうといった、想定外のことが起きやすいです。
...
「FiNC Technologies TECH BOOK」ではこの手法を用いています。この本の場合はScrapboxというドキュメントツールを使って全員が執筆しました。
Scrapbox自体は社内で使われているもので、全員が不自由なく使えるツールだったためです。これにより執筆や編集をスムーズに行うことができました。
更に会社本ということで広報チェックが入ったのですが、広報スタッフもScrapboxが使えたのでチェック作業も滞りなく行えました。
