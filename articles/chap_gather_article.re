...
そのため、既に執筆者がブログなどで書いた経験がある良さそうなテーマを主催から提示するというようなサポートをすると良いでしょう。

執筆未経験の人が多い場合はなるべく使い慣れたツールで書いてもらう方が良いこともあります。
記法を覚えてもらうよりも、先に使い慣れたツールで原稿を書き進めてもらい最終的に主催側がRe:VIEW記法などの記法に修正するという手法です。
例えば、「FiNC Technologies TECH BOOK」はこの手法を用いました。
執筆未経験の人が多く、全員に記法を覚えてもらうのは非効率であると考えScrapboxというWikiツールを使って全員執筆することにしました。
執筆が終わり次第Re:VIEW記法に主催側が修正して、最終的なpdfに落とし込むというフローにしました。
これは結果としてうまくいきました。Scrapbox自体は社内で使われているドキュメントツールなので、全員が不自由なく使えるツールでした。
また共同編集にも強く進捗が常に確認できるのも、良い点です。
また、会社本ということで広報チェックが入ったのですが、広報スタッフもScrapboxが使えたので、そのあたりも滞りなく行えました。
