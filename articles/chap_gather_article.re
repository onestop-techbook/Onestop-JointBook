...
私たちはこれまでいくつかの合同誌を作ってきましたが、その度に規模や書く人の技量など状況が違いました。そうなると、そもそもの作り方やどのように多くの執筆者から原稿を集めてくるかが変わってきます。主催者は執筆者にどのように原稿を頼むべきなのか、執筆者に対してどのように接するべきなのか、考えることは山のようにあります。もちろん、執筆者が締め切りになっても原稿を上げてこないなんてトラブルは当然のようにあります。（笑）
...
== 同人サークルとして合同誌を作る場合
この項では同人サークルとして合同誌を作る場合について述べます。
これは次の項の企業として合同誌を作る場合と対比する項になっています。

この項では更に合同誌をストーリー形式とアンソロジー形式の2つに分類します。
ストーリー形式とは一冊を通して一つの続き物の話になっており、後ろの章は前の基本的に最初から読むことを想定して書くものになります。
アンソロジー形式とは個々の要素が独立しており、読者が好きな章から読めるように構成されているもので、この本の形式がまさにそれになります。
なお、この分類方法はこの項独自であり、一般的に通用するとは限りません。
筆者がこれまで作った三種類のパターンに分けて、そのパターン毎に書いていきます。
各パターンはどれも4-5人程度で、ひとりひとりが10ページほどの原稿を書く場合を想定しています。

=== ケース1 経験者かつアンソロジー形式の場合
合同誌を書く人の多くが執筆経験があり、かつ個々の原稿が独立している場合です。
筆者の場合、「Microservices architecture よろず本 その二」をこの形式で進めました。

この形式の場合は前に揚げた共通事項を除くとほとんどすることはありません。
個々の執筆者はそれぞれある程度のレベルで文章が書けることが期待できますし、大まかな本の作り方もわかっているため、それぞれが自走して作っていけます。
そのため、始めに合同誌自体のテーマを決めれば以降の介入はあまり必要なく、執筆環境を整えたり、書く内容が被らないように調整するなど、基礎部分についてのみ気をつければ良いです。

ただし、個別に書き進めていくのはハマりやすくはあるので、
テーマがうまく決められているか、原稿の進捗は良いかといった所は初期のうちに注意して見ておき、危なそうなら早めに対処しておくと安全です。
初期を乗り越えて着手できればだいたい大丈夫です。

各執筆者の能力に期待できるため、原稿を集める段階においては困難になる箇所は少ないです。
このケースの場合、最初にうまく回るように場を作るところや、原稿ができた後の編集作業など、原稿を書く前後の部分に労力がかかりますが、原稿を集める苦労はそこまで大変では無いと思います。

=== ケース2 未経験者かつアンソロジー形式の場合
合同誌を書く人の多くが執筆未経験であり、かつ個々の原稿が独立している場合です。
筆者の場合、「Microservices architecture よろず本」および「Amazon Web Services サーバーレスレシピ 2018.04」をこの形式で進めました。
...
このケースの場合も大きな流れは経験者かつアンソロジー形式と同じく、最初に合同誌のテーマを決めますが、その後の原稿に対しても定期的にサポートをしたほうが良いです。
本のテーマを決めて各自に進めてもらう場合、書き慣れてないと徐々にテーマからずれた原稿になってしまう場合や内容が最終的にかぶってしまうといった、想定外の内容になってしまう場合があります。

また、本人も文章を書くスピードがわからない場合が多いため、進捗が思った以上に出なくて締め切りを過ぎてしまうといった場合もあります。実際、締め切りをかなりすぎてしまい、バッファ込みで取っておいた編集作業がかなり圧迫されるという問題が起きたことがありました。
この形式の場合は個々の執筆者の自由度が高いため、ある程度原稿を書いているときも介入するとお互いにとって安心して進められると思います。
...
全体として一つのストーリーになるので、個人個人が独立して動けるようになるまで細かく分解していく必要があります。
...
図@<img>{gather_article/gather_article}が一番最初に決めた内容になります。
...
ただし、全体を通して一つのものになるので、文言の統一などは他の形式と違ってかなり注意深く見る必要があります。


=== ケース4 未経験かつアンソロジー形式の場合
合同誌を書く人の多くが執筆未経験であり、かつ個々の原稿が独立している場合です。
著者の場合、「FiNC Technologies TECH BOOK」をこの形式で進めました。

基本的にはケース2の場合はほぼ変わりません。ただし、この本は参加人数が多かったという部分と会社で執筆した部分とに違いがあります。

参加人数が多かったため、全員にRe:VIEWなどのフォーマットを覚えてもらうというのは非効率であると考え、ScrapboxというWikiツールを使って全員執筆することにしました。執筆が終わり次第Re:VIEWフォーマットに主催側が修正して、最終的なpdfに落とし込むというフローにしました。これは結果としてうまくいきました。Scrapbox自体は社内で使われているドキュメントツールなので、全員が不自由なく使えるツールでした。また共同編集にも強く進捗が常に確認できるのも、良い点です。また、会社本ということで広報チェックが入ったのですが、広報スタッフもScrapboxが使えたので、そのあたりも滞りなく行えました。
