...
普段は「レーザープロジェクタを自作するためのいろいろ」というあたりのネタで執筆中。コミケと技術書典に出没。

デッドライナーだけど、最近締め切りをでっち上げて自分の尻を叩く方法を学んだので、コンスタントに本が書けるようになった。プログラミングは苦手。しめきりたのしー。

ワンストップ本1こと、技術同人誌を書こうが商業化したり、錬金ラボをみんなで作ったり、楽しすぎる毎日です。
...
//embed{
    ...
    \hspace{1ex} 
//}
フリーランスでWebデザイナー・漫画家・技術書執筆・Live2Dモデラーをやっているスペースデブリ（宇宙ゴミ）。『わかばちゃんと学ぶ』シリーズ著者。

技術書典6で新刊『マンガでわかるRuby』を出すべく奮闘中。

親方さんにはワンストップシリーズの表紙を、毎度早め早めにご依頼いただき、感謝のこと山のごとしです。

表紙のキャラクターは「ワンストップちゃん」と言います。自分で描いといてなんですが、天使でスカンクで性別不詳キャラは最強だと思います。

今回、親方さんの発案で「ブランチ多めのコミットグラフが連なっているのを背景にしたい！」とのことだったのでそれっぽくしてみました。ぐわぁ〜ってなったコミットグラフ見るのって楽しいですよね。

『ワンストップ勉強会 -参加・登壇・主催まで-』には、表紙のみならず序盤にワンストップちゃんのマンガも描いてますのでそちらも合わせてお楽しみください！
