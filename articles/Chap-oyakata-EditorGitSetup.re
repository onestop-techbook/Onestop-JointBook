...
//footnote[docker][著者・寄稿者がやりたいのは執筆であり、Dockerの構築ではありません。特にWindowsではDockerローカル環境を作るだけでも結構大変だったり。仮想環境をすでに持っている、勉強兼ねてやってみるということそれ自体は良いことですが、初めて本を書こうとしている人に、じゃあ次にDocker環境作りましょう。というのは本末転倒が過ぎるでしょう。そもそも、覚えるものが増えます。]
