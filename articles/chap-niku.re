...
ソフトウエアと異なり、原稿ファイルであれば「予期せぬ挙動・バグ」が混入するという可能性はほとんどありません。CIを走らせていれば、Re:view構文のミスなどはそちらで見つけてもらえます（原稿のコンパイルにミスる、表示がずれる、章のネストが変になる等はありえます）。これらは、原則Pushした著者が直すように、と明記・周知すると良いでしょう。
...
執筆を進めるうえでの小ネタ的なネタを記載しました。ネタ出しの鉄板メソッド、肉肉野菜肉野菜ご飯、そしてセルフマージを推奨するのがよい。お役に立ちましたら幸いです。