...
最初から遅れることを前提にバッファを立てておく。これらの対応で精神の平穏は相当保たれます。
...
反応的に書いてしまうのはよくない。「ん？」と思うことがあっても冷静に対処すること。1日で対応する時間を決めて返信した方がよい。
...
「仕事が忙しい」「引っ越し」「体調不良」などなど、参加者が多いほど不慮の事態がめちゃくちゃ発生します。原稿は予定通りは上がってきません。1週間ぐらいバッファを持っておくとOK！

対策として、とにかく早めの発信・依頼をして、作業者の時間を確保する。です。具体的には、金曜夜/土曜日の朝にリマインドして日曜日には完了できるようにする
